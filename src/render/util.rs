...
pub fn print_adapter_info<B: Backend>(adapter: &Adapter<B>) {
    ...
    println!(
        ...
        limits.max_compute_group_count
    );
    println!(
        "\tmax_compute_group_size: {:?}",
        limits.max_compute_group_size
    );
    println!(
    ...
    println!(
        "\tmin_buffer_copy_offset_alignment: {}",
        limits.min_buffer_copy_offset_alignment
    );
    println!(
        "\tmin_buffer_copy_pitch_alignment: {}",
    ...
    println!(
        "\tframebuffer_depth_samples_count: {}",
        limits.framebuffer_depth_samples_count
    );
    println!(
        "\tframebuffer_stencil_samples_count: {}",
        limits.framebuffer_stencil_samples_count
    );
